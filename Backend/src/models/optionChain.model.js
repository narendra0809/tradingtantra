...
export const NiftyOptionChain = mongoose.model(
  "NiftyOptionChain",
  optionChainSchema
);
export const BankNiftyOptionChain = mongoose.model(
  "BankNiftyOptionChain",
  optionChainSchema
);
export const FinniftyOptionChain = mongoose.model(
  "FinniftyOptionChain",
  optionChainSchema
);
export const MidcpNiftyOptionChain = mongoose.model(
  "MidcpNiftyOptionChain",
  optionChainSchema
);
export const SensexOptionChain = mongoose.model(
  "SensexOptionChain",
  optionChainSchema
);
