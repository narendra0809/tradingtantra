...
import fivedays from "../../../../assets/Images/Dashboard/AiSwingTradesPAge/fiveDay.png";
import { useEffect, useState } from "react";
import Lock from "../../Lock";
import StrategyCard from "../../../StrategyCard";

const FiveDayBO = ({ data, loading, error, isSubscribed }) => {
                ...
                <table className="w-full">
                  ...
                  <thead className="sticky top-0 dark:bg-db-secondary bg-[#EEEEEE] z-10">
                    <tr className="dark:text-gray-300 ">
                      ...
                      <th
                        className="py-2 text-center whitespace-nowrap text-xs sm:text-sm"
