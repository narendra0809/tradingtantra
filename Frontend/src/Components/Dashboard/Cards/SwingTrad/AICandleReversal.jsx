...
import reversalRader from "../../../../assets/Images/Dashboard/AiSwingTradesPAge/reversalRadar.png";
...
const AICandleReversal = ({ data, loading, error, isSubscribed }) => {
  ...
  const handleSortByType = () => {
    ...
    const sorted = [...sortedData].sort((a, b) =>
      newOrder === "asc"
        ? String(a.trend).localeCompare(String(b.trend))
        : String(b.trend).localeCompare(String(a.trend))
    );
    ...
    <div className="relative w-full h-[360px] dark:bg-gradient-to-tr from-[#0009B2] to-[#02000E] rounded-lg p-px overflow-hidden">
      <div className="w-full h-full dark:bg-db-primary bg-primary-light rounded-lg p-2">
        ...
        <StrategyCard
          ...
          title={"AI Candle Reversal (TF-Daily)"}
          imageSrc={reversalRader}
          imageAlt={"logo"}
        />
...
export default AICandleReversal;
