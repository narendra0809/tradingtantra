...
const AIMomentumCatcherTenMins = ({ data, loading, error, isSubscribed }) => {
  ...
  return (
    <div className="relative w-full h-[360px] dark:bg-gradient-to-tr from-[#0009B2] to-[#02000E] rounded-lg p-px overflow-hidden">
      <div className="w-full h-full dark:bg-db-primary bg-primary-light rounded-lg p-2">
        ...
        <StrategyCard
          Icon={FcCandleSticks}
          name={"momentum-catcher-ten"}
          title={"AI Momentum Catcher 10 Min"}
          imageSrc={candles}
          imageAlt={"logo"}
        />
...
export default AIMomentumCatcherTenMins;
