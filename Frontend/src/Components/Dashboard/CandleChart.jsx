...
const CandleChart = ({ candles }) => {
      ...
      },
      {
        ...
        data: enhancedCandles.map(candle => ({
          ...
          fillColor: candle.isUp 
            ? (theme === "dark" ? "#10B98133" : "#05966933") // Shaded green for up
            : (theme === "dark" ? "#EF444433" : "#DC262633") // Shaded red for down
        }))
      }
    ],
    options: {
  ...
  return (
    <div id="chart" className="h-full w-full p-0 m-0" style={{ padding: 0, margin: 0 }}>
      <Chart
