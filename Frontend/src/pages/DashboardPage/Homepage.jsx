    ...
    <>
      ...
      <section className="w-full space-y-5">
        {cards.map((card, index) => (
          <div
            key={index}
            className="flex lg:flex-row flex-col gap-5 p-4 dark:bg-db-primary bg-[#ffffff] rounded-[10px] min-h-[200px]"
          >
            {/* Image Section */}
            <img
            ...
            {/* Text Section */}
            <div className="dark:bg-db-secondary bg-[#EEEEEE] rounded-[10px] p-4 flex-1 flex flex-col justify-start gap-10">
