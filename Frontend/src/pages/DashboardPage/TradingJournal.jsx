...
//             <button
//               className="text-sm font-normal bg-primary rounded-[5px] py-2 px-3"
...
//             <section className="bg-gradient-to-tr from-[#0009B2] to-[#02000E] p-px rounded-md">
//               <div className="dark:bg-db-secondary bg-db-primary shadow-lg rounded-md p-3 h-full">
//                 <Calendar
...
//                           date.toDateString()
//                       );
//                       return isHoliday ? "bg-pink-100" : null;
//                     }
//                   }}
//                 />
//               </div>
...
//                         Exchanges Closed: {holiday.closed_exchanges.join(", ")}
//                       </p>
//                     </div>
//                   ))}
//                 </div>
//               ) : (
//                 <p className="text-center">No upcoming holidays found.</p>
//               )}
//             </div>
//           </section>
//         </div>
...
const TradingJournal = () => {
  ...
  // Use dateRange.startDate for Calendar month, fallback to today if not set
  const calendarMonth = dateRange.startDate
    ? new Date(
