...
const ProfitPage = () => {
  return (
    <div className="mt-10 space-y-10">
      ...
      <div className="dark:bg-db-primary bg-db-primary  border border-[#0009B250] p-5 rounded-[5px] space-y-10">
        ...
        <div className=" text-base font-abcRepro space-y-4">
          ...
          <p className="font-normal ">
            ...
            us. We don't use for active conversation. If you want to give any
            feedback to us, then kindly use feedback tab in the TradeFinder
            Menu.
          </p>
        </div>
      </div>
