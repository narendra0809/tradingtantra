      ...
      <section className="font-abcRepro space-y-10 mt-40">
          ...
          <div className="space-y-4">
            <ol className="list-decimal pl-10">
              <li className="text-[#C6C6C6] text-base">
                ...
                Services on it, available to users. TradeFinder, Owner, Us, We,
        ...
        <div className="space-y-5">
          ...
          <p className="font-light md:text-xl text-lg  ">
            ...
            Website and Services to You if You assent to these Terms of Service.
        ...
        <div className="space-y-5">
          ...
          <p className="font-light md:text-xl text-lg ">
            ...
            legally agree to these Terms of Service. The Owner assumes no
        ...
        <div className="space-y-5">
          ...
          <p className="font-light md:text-xl text-lg ">
            ...
            the products on the Website at our sole discretion to anyone for any
            reason at any time.
          </p>
          ...
          <p className="font-light md:text-xl text-lg ">
            ...
            infringing the rights of or restricting the use of this Website by
            any third party.
          </p>
        </div>
        {/* point 5 */}
        ...
        <div className="space-y-5">
          ...
          <p className="font-light md:text-xl text-lg ">
            ...
            provide us, including credit card, billing address, and other
            payment information, is subject to the same confidentiality and
            accuracy requirements as the rest of Your identifying information.
            Providing false or inaccurate information or using the Website or
            Services to further fraud or unlawful activity is grounds for
            immediate termination of these Terms of Service. The Owner reserves
        ...
        <div className="space-y-5">
          ...
          <p className="font-light md:text-xl text-lg ">
            ...
            you have selected and consent to receive communications via phone or
            electronic records from the Website including e-mail messages
            telling you about products and services offered by the Website (or
            its affiliates and partners) and understanding your requirements.
          ...
          <div className="space-y-4">
            <ol className="list-decimal pl-10">
              ...
              <li className="text-[#C6C6C6] text-base">
                ...
                the Owner may store some information about You for future
                reference for the following number of days: 90. After that time,
                it will be deleted.
              </li>
            </ol>
          </div>
        ...
        <div className="space-y-5">
          ...
          <p className="font-light md:text-xl text-lg ">
            ...
            between You and the Owner. You further agree that Your purchase of
            any of the products on the Website is at Your own risk. The Owner
            does not assume responsibility or liability for any advice or other
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-4">
            ...
            <ol className="list-decimal pl-10">
              ...
              <li className="text-[#C6C6C6] text-base">
                (if earlier) 30 days after the day you provide evidence that you
                have returned the goods; or
              </li>
              <li className="text-[#C6C6C6] text-base">
                if there were no goods supplied, 30 days after the day on which
        ...
        <div className="space-y-5">
          ...
          <p className="font-light md:text-xl text-lg ">
            ...
            legal counsel and may participate in its own defence if the Owner
            wishes.
          </p>
        </div>
        {/* point 18 */}
        ...
        <div className="space-y-5">
          ...
          <p className="font-light md:text-xl text-lg ">
            ...
            herein. You further agree that all modifications to these Terms of
            Service are in full force and effect immediately upon posting on the
            Website and that modifications or variations will replace any prior
            version of these Terms of Service unless prior versions are
            specifically referred to or incorporated into the latest
            modification or variation of these Terms of Service.
          </p>
          <div className="space-y-4">
            <ol className="list-decimal pl-10">
              <li className="text-[#C6C6C6] text-base">
                To the extent any part or sub-part of these Terms of Service is
                held ineffective or invalid by any court of law, You agree that
                the prior, effective version of these Terms of Service shall be
                considered enforceable and valid to the fullest extent.
              </li>
              <li className="text-[#C6C6C6] text-base">
                You agree to routinely monitor these Terms of Service and refer
                to the Effective Date posted at the top of these Terms of
        ...
        <div className="space-y-5">
          ...
          <p className="font-light md:text-xl text-lg ">
            ...
            to, violating the intellectual property rights of the Owner or a
            third party, failing to comply with applicable laws or other legal
            obligations, and/or publishing or distributing illegal material. If
            You have registered for an account with Us, You may also terminate
            these Terms of Service at any time by contacting Us and requesting
            termination. Please keep in mind that any outstanding fees will
            still be due even after termination of Your account. At the
            termination of these Terms of Service, any provisions that would be
        ...
        <div className="space-y-5">
          ...
          <p className="font-light md:text-xl text-lg ">
            ...
            from third parties or advertisers is made available without making
            any changes and so the Website cannot guarantee accuracy and is not
            liable for any inconsistencies arising thereof. All postings,
            messages, advertisements, photos, sounds, images, text, files,
            video, or other materials posted on, transmitted through, or linked
          ...
          <p className="font-light md:text-xl text-lg ">
            ...
            provided by You cannot be hacked by any unauthorised third parties.
          ...
          <p className="font-light md:text-xl text-lg ">
            ...
            the Website by third parties or for any such use of the information
            provided by You or any spam messages or information that You may
            receive from any such unauthorised third party (including those
            which are although sent representing the name of the Website but
          ...
          <p className="font-light md:text-xl text-lg ">
            ...
            If despite the limitation above, We are found liable for any loss or
            damage which arises out of or in any way connected with the use of
            the Website and/or provision of Services, then the liability will in
        ...
        <div className="space-y-5">
          ...
          <p className="font-light md:text-xl text-lg ">
            ...
            relating to these Terms of Service is limited to the lesser of Rs.
            1000 (Rupees One Thousand only) or the amount You paid to the Owner
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-4">
            <ol className="list-decimal pl-10">
              ...
              <li className="text-[#C6C6C6] text-base">
                JURISDICTION, VENUE & GOVERNING LAW: Through Your use of the
                Website or Services, You agree that the laws of India shall
                govern any matter or dispute relating to or arising out of these
                Terms of Service, as well as any dispute of any kind that may
                arise between You and the Owner, with the exception of its
                conflict of law provisions. In case any litigation specifically
                permitted under these Terms of Service is initiated, the Parties
                agree to submit to the exclusive jurisdiction of the courts at
                Patna, Bihar, India. The Parties agree that this choice of law,
                venue, and jurisdiction provision is not permissive, but rather
                mandatory in nature. You hereby waive the right to any objection
                of venue, including assertion of the doctrine of forum
                non-conveniens or similar doctrine.
              </li>
              <li className="text-[#C6C6C6] text-base">
                ASSIGNMENT: This Agreement, or the rights granted hereunder, may
                not be assigned, sold, leased or otherwise transferred in whole
                or part by You. Should these Terms of Service, or the rights
                granted hereunder, by assigned, sold, leased or otherwise
                transferred by the Owner, the rights and liabilities of the
                Owner will bind and inure to any assignees, administrators,
                successors and executors.
              </li>
              <li className="text-[#C6C6C6] text-base">
                SEVERABILITY: If any part or sub-part of these Terms of Service
                ...
                of these Terms of Service shall continue in full force.
              </li>
              <li className="text-[#C6C6C6] text-base">
                NO WAIVER: In the event that We fail to enforce any provision of
                these Terms of Service, this shall not constitute a waiver of
                any future enforcement of that provision or of any other
                provision. Waiver of any part or sub-part of these Terms of
                Service will not constitute a waiver of any other part or
                sub-part.
              </li>
              <li className="text-[#C6C6C6] text-base">
                HEADINGS FOR CONVENIENCE ONLY: Headings of parts and sub-parts
                under these Terms of Service are for convenience and
              ...
              <li className="text-[#C6C6C6] text-base">
                ...
                or joint venture has been created between the Parties as a
                result of these Terms of Service. No Party has any authority to
                bind the other to third parties.
              </li>
              <li className="text-[#C6C6C6] text-base">
                FORCE MAJEURE: The Owner is not liable for any failure to
              ...
              <li className="text-[#C6C6C6] text-base">
                ELECTRONIC COMMUNICATIONS PERMITTED: Electronic communications
                are permitted to both Parties under these Terms of Service,
                including e-mail or fax.
              </li>
              <li className="text-[#C6C6C6] text-base">
                REFUND POLICY: No Refunds. All sales are final, and the Company
                does not offer any money-back guarantees. You recognize and
                agree that you shall not be entitled to a refund for any
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc">
              ...
              <li className=" text-base">
                ...
                educational purposes and should not be construed as investment
                advice by TradingTantra. Investors should consult their
